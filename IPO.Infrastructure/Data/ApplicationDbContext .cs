...
namespace IPO.Infrastructure.Data
{
    public class ApplicationDbContext : DbContext
    {
        ...
        public DbSet<IPOInstrument> IPOInstruments { get; set; }
        public DbSet<OneMinuteCandle> OneMinuteCandles { get; set; }
        public DbSet<LiveMarketPrice> LiveMarketPrices { get; set; }
