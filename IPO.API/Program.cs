...
builder.Services.AddScoped<UpstoxHistoricalService>();
builder.Services.AddScoped<UpstoxInstrumentService>();


builder.Services.Configure<UpstoxOptions>(
    builder.Configuration.GetSection("Upstox"));

builder.Services.AddHttpClient<UpstoxApiClient>();
